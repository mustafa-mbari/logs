          ...
          {exceptions.map((ex, index) => (
            <li key={index} style={{ color: "red", marginBottom: "10px" }}>
              <strong 
                ...
                onClick={() => console.log(`Navigate to line ${ex.lineNumber}`)}
              >
              ...
              {expandedExceptions[index] && (
                <pre style={{ color: "gray", background: "#f8f8f8", padding: "5px", borderRadius: "5px", userSelect: "text", pointerEvents: "none" }}>
                  {ex.stackTrace.join("\n")}
                </pre>
              )}
